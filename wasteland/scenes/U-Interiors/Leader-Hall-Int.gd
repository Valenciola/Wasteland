...
@export var target_scene : String = "res://scenes/Utopia-Ext.tscn"   # scene to load
@export var spawn_point_name : String = "Leader-Hall-Exit"                 # marker name in target scene
