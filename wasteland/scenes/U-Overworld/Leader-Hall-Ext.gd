...
@export var target_scene : String = "res://scenes/U-Interiors/Leader-Hall-Int.tscn"   # scene to load
@export var spawn_point_name : String = "Leadership-Hall-Spawn"                 # marker name in target scene
