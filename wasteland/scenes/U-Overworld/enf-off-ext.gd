...
@export var target_scene : String = "res://scenes/U-Interiors/Enforcer-Office-Int.tscn"   # scene to load
@export var spawn_point_name : String = "Enf-Off-Spawn"                 # marker name in target scene
