...
@export var target_scene : String = "res://scenes/U-Interiors/Enforcer-Res-Int.tscn"   # scene to load
@export var spawn_point_name : String = "Enf-Res-Spawn"                 # marker name in target scene
