...
@export var target_scene : String = "res://scenes/U-Interiors/Reb-South-Int.tscn"   # scene to load
@export var spawn_point_name : String = "Reb-South-Spawn"                 # marker name in target scene
