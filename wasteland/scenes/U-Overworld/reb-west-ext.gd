...
@export var target_scene : String = "res://scenes/U-Interiors/Reb-West-Int.tscn"   # scene to load
@export var spawn_point_name : String = "Reb-West-Spawn"                 # marker name in target scene
