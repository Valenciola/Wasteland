...
@export var target_scene : String = "res://scenes/Wasteland-Ext.tscn"   # scene to load
@export var spawn_point_name : String = "TrainStation-Exit"                 # marker name in target scene
