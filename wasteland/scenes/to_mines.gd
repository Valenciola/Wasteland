...
@export var target_scene : String = "res://scenes/U-Interiors/Mining-Int.tscn"   # scene to load
@export var spawn_point_name : String = "Mine-Spawn"                 # marker name in target scene
