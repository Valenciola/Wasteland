...
@export var target_scene : String = "res://scenes/U-Interiors/TrainStation-U-Int.tscn"   # scene to load
@export var spawn_point_name : String = "Train-Spawn"                 # marker name in target scene
